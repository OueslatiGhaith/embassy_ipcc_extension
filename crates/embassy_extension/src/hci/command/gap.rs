...
pub use bluetooth_hci::types::{ConnectionInterval, ExpectedConnectionLength, ScanWindow};
pub use bluetooth_hci::{BdAddr, BdAddrType};
...
pub trait GapCommands {
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetNonDiscoverable) event
    /// is generated.
    ...
    /// status](bluetooth_hci::event::Event::CommandStatus) event. The controller starts the advertising after
    ...
    /// Complete](crate::hci::event::BlueNRGEvent::GapLimitedDiscoverableTimeout) event.
    ...
    /// # Generated evenst
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetDiscoverable) event is
    /// generated.
    fn set_discoverable(
        &mut self,
        params: &DiscoverableParameters<'_, '_>,
    ...
    /// # Generated evenst
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetDirectConnectable) event
    /// is generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetIoCapability) event is
    /// generated.
    ...
    ///
    /// - A [Command
    ///   Complete](crate::hci::event::command::ReturnParameters::GapSetAuthenticationRequirement) event
    ///   is generated.
    /// - If [`fixed_pin`](AuthenticationRequirements::fixed_pin) is [Request](Pin::Requested), then
    ///   a [GAP Pass Key](crate::hci::event::BlueNRGEvent::GapPassKeyRequest) event is generated.
    ...
    ///
    /// - A [Command
    ///   Complete](crate::hci::event::command::ReturnParameters::GapSetAuthorizationRequirement) event
    ///   is generated.
    /// - If authorization is required, then a [GAP Authorization
    ///   Request](crate::hci::event::BlueNRGEvent::GapAuthorizationRequest) event is generated.
    fn set_authorization_requirement(
        &mut self,
        conn_handle: bluetooth_hci::ConnectionHandle,
        authorization_required: bool,
    ) -> nb::Result<(), Self::Error>;

    /// This command should be send by the host in response to the [GAP Pass Key
    /// Request](crate::hci::event::BlueNRGEvent::GapPassKeyRequest) event.
    ///
    ...
    /// # Generated events
    ///
    /// - A [Command Complete](crate::hci::event::command::ReturnParameters::GapPassKeyResponse) event is
    ///   generated.
    /// - When the pairing process completes, it will generate a
    ///   [PairingComplete](crate::hci::event::BlueNRGEvent::GapPairingComplete) event.
    ...
    /// Request](crate::hci::event::BlueNRGEvent::GapAuthorizationRequest) event.
    ///
    /// # Errors
    ///
    /// Only underlying communication errors are reported.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapAuthorizationResponse)
    /// event is generated.
    ...
    /// data](crate::hci::event::command::GapInit).
    ///
    /// # Errors
    ///
    /// Only underlying communication errors are reported.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapInit) event is generated.
    fn init(
        &mut self,
        role: Role,
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetUndirectedConnectable)
    /// event is generated.
    ...
    /// # Generated events
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event will be generated when a valid
    ...
    /// Initiated](crate::hci::event::BlueNRGEvent::GapPeripheralSecurityInitiated) vendor-specific event
    /// will be generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapUpdateAdvertisingData)
    /// event is generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapDeleteAdType) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapGetSecurityLevel) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapSetEventMask) event is
    /// generated.
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapConfigureWhiteList) event
    /// is generated.
    ...
    ///   invalid. Valid reasons are the same as HCI [disconnect](bluetooth_hci::host::bluetooth_Hci::disconnect):
    ///   [`AuthFailure`](bluetooth_hci::Status::AuthFailure),
    ///   [`RemoteTerminationByUser`](bluetooth_hci::Status::RemoteTerminationByUser),
    ///   [`RemoteTerminationLowResources`](bluetooth_hci::Status::RemoteTerminationLowResources),
    ///   [`RemoteTerminationPowerOff`](bluetooth_hci::Status::RemoteTerminationPowerOff),
    ///   [`UnsupportedRemoteFeature`](bluetooth_hci::Status::UnsupportedRemoteFeature),
    ///   [`PairingWithUnitKeyNotSupported`](bluetooth_hci::Status::PairingWithUnitKeyNotSupported), or
    ///   [`UnacceptableConnectionParameters`](bluetooth_hci::Status::UnacceptableConnectionParameters).
    /// - Underlying communication errors.
    ///
    /// # Generated events
    ///
    /// The controller will generate a [command status](bluetooth_hci::event::Event::CommandStatus) event when
    /// the command is received and a [Disconnection
    /// Complete](bluetooth_hci::event::Event::DisconnectionComplete) event will be generated when the link is
    /// disconnected.
    fn terminate(
        &mut self,
        conn_handle: bluetooth_hci::ConnectionHandle,
        reason: bluetooth_hci::Status<crate::hci::event::Status>,
    ) -> nb::Result<(), Error<Self::Error>>;
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapClearSecurityDatabase)
    /// event is generated.
    ...
    /// Lost](crate::hci::event::BlueNRGEvent::GapBondLost) event if it wants the re-bonding to happen
    /// successfully. If this command is not given on receiving the event, the bonding procedure
    /// will timeout.
    ///
    /// # Errors
    ...
    /// # Generated events
    ///
    /// A [Command Complete](crate::hci::event::command::ReturnParameters::GapAllowRebond) event is
    /// generated. Even if the command is given when it is not valid, success will be returned but
    /// internally it will have no effect.
    fn allow_rebond(
        &mut self,
    ...
    /// # Generated events
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated as soon as the
    /// command is given.
    ///
    /// If [Success](bluetooth_hci::Status::Success) is returned in the command status, the procedure is
    ...
    /// procedure code set to [LimitedDiscovery](crate::hci::event::GapProcedure::LimitedDiscovery) or a
    /// [timeout](crate::hci::event::BlueNRGEvent::GapLimitedDiscoverableTimeout) happens. When the
    /// procedure is terminated due to any of the above reasons, a
    /// [ProcedureComplete](crate::hci::event::BlueNRGEvent::GapProcedureComplete) event is returned with
    /// the procedure code set to [LimitedDiscovery](crate::hci::event::GapProcedure::LimitedDiscovery).
    ///
    /// The device found when the procedure is ongoing is returned to the upper layers through the
    /// [LeAdvertisingReport](bluetooth_hci::event::Event::LeAdvertisingReport) event.
    ...
    /// terminated when either the upper layers issue a command to terminate the procedure by
    /// issuing the command [`terminate_procedure`](Commands::terminate_procedure) with the
    /// procedure code set to [GeneralDiscovery](crate::hci::event::GapProcedure::GeneralDiscovery) or a
    /// timeout happens. When the procedure is terminated due to any of the above reasons, a
    /// [ProcedureComplete](crate::hci::event::BlueNRGEvent::GapProcedureComplete) event is returned with
    /// the procedure code set to [GeneralDiscovery](crate::hci::event::GapProcedure::GeneralDiscovery).
    ///
    /// The device found when the procedure is ongoing is returned to the upper layers through the
    /// [LeAdvertisingReport](bluetooth_hci::event::Event::LeAdvertisingReport) event.
    ...
    ///
    /// A [LE Create Connection](bluetooth_hci::host::bluetooth_Hci::le_create_connection) call will be made to the
    /// controller by GAP with the [initiator filter
    /// policy](bluetooth_hci::host::ConnectionParameters::initiator_filter_policy) set to
    /// [UseAddress](bluetooth_hci::host::ConnectionFilterPolicy::UseAddress), to "ignore whitelist and
    ...
    /// [ProcedureComplete](crate::hci::event::BlueNRGEvent::GapProcedureComplete) event is given to the
    ...
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated as soon as the
    /// command is given. If [Success](bluetooth_hci::Status::Success) is returned, on completion of the
    /// procedure, a [ProcedureComplete](crate::hci::event::BlueNRGEvent::GapProcedureComplete) event is
    /// returned with the procedure code set to
    /// [NameDiscovery](crate::hci::event::GapProcedure::NameDiscovery).
    ...
    /// [`le_create_connection`](bluetooth_hci::host::bluetooth_Hci::le_create_connection) call will be made to the
    /// controller by GAP with the [initiator filter
    /// policy](bluetooth_hci::host::ConnectionParameters::initiator_filter_policy) set to
    /// [WhiteList](bluetooth_hci::host::ConnectionFilterPolicy::WhiteList), to "use whitelist to determine
    /// which advertiser to connect to". When a command is issued to terminate the procedure by
    /// upper layer, a [`le_create_connection_cancel`](bluetooth_hci::host::bluetooth_Hci::le_create_connection_cancel)
    ...
    ///
    /// The host [enables scanning](bluetooth_hci::host::bluetooth_Hci::le_set_scan_enable) in the controller with the
    /// scanner [filter policy](bluetooth_hci::host::ScanParameters::filter_policy) set to
    /// [AcceptAll](bluetooth_hci::host::ScanFilterPolicy::AcceptAll), to "accept all advertising packets" and
    /// from the scanning results, all the devices are sent to the upper layer using the event [LE
    /// Advertising Report](bluetooth_hci::event::Event::LeAdvertisingReport). The upper layer then has to
    ...
    /// scanning](bluetooth_hci::host::bluetooth_Hci::le_set_scan_enable) in the controller with the scanner [filter
    /// policy](bluetooth_hci::host::ScanParameters::filter_policy) set to
    /// [WhiteList](bluetooth_hci::host::ScanFilterPolicy::WhiteList), to "accept packets only from devices in
    /// whitelist". All the devices found are sent to the upper layer by the event [LE Advertising
    /// Report](bluetooth_hci::event::Event::LeAdvertisingReport). The upper layer then has to select one of
    ...
    /// controller by GAP with the initiator [filter
    /// policy](bluetooth_hci::host::ConnectionParameters::initiator_filter_policy) set to
    /// [UseAddress](bluetooth_hci::host::ConnectionFilterPolicy::UseAddress) to "ignore whitelist and process
    ...
    /// [`le_create_connection_cancel`](bluetooth_hci::host::bluetooth_Hci::le_create_connection_cancel) call will be
    ...
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated as soon as the
    /// command is given. If [Success](bluetooth_hci::Status::Success) is returned, on termination of the
    /// procedure, a [LE Connection Complete](bluetooth_hci::event::LeConnectionComplete) event is
    ...
    /// to
    /// [DirectConnectionEstablishment](crate::hci::event::GapProcedure::DirectConnectionEstablishment).
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapTerminateProcedure) event
    /// is generated for this command. If the command was successfully processed, the status field
    /// will be [Success](bluetooth_hci::Status::Success) and a
    /// [ProcedureCompleted](crate::hci::event::BlueNRGEvent::GapProcedureComplete) event is returned
    ...
    ///
    /// A [`le_connection_update`](bluetooth_hci::host::bluetooth_Hci::le_connection_update) call is be made to the
    /// controller by GAP.
    ///
    /// # Errors
    ///
    ...
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated as soon as the
    /// command is given. If [Success](bluetooth_hci::Status::Success) is returned, on completion of
    /// connection update, a
    /// [LeConnectionUpdateComplete](bluetooth_hci::event::Event::LeConnectionUpdateComplete) event is
    ...
    /// # Generated events
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated when the command is
    /// received. If [Success](bluetooth_hci::Status::Success) is returned in the command status event, a
    /// [Pairing Complete](crate::hci::event::BlueNRGEvent::GapPairingComplete) event is returned after
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapResolvePrivateAddress)
    /// event is generated. If [Success](bluetooth_hci::Status::Success) is returned as the status, then the
    /// address is also returned in the event.
    fn resolve_private_address(
        &mut self,
        addr: bluetooth_hci::BdAddr,
    ) -> nb::Result<(), Self::Error>;
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapGetBondedDevices) event is
    /// generated.
    ...
    ///   [ScannableUndirected](bluetooth_hci::types::AdvertisingType::ScannableUndirected) or
    ///   [NonConnectableUndirected](bluetooth_hci::types::AdvertisingType::NonConnectableUndirected).
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapSetBroadcastMode) event is
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapStartObservationProcedure)
    /// event is generated.
    ...
    /// command will return [Success](bluetooth_hci::Status::Success).
    ///
    /// # Errors
    ///
    /// Only underlying communication errors are reported.
    ...
    /// # Generated events
    ///
    /// A [command complete](crate::hci::event::command::ReturnParameters::GapIsDeviceBonded) event is
    /// generated.
    fn is_device_bonded(
        &mut self,
        addr: bluetooth_hci::host::PeerAddrType,
    ) -> nb::Result<(), Self::Error>;
}

impl<'buf, const N: usize> GapCommands for crate::hci::RadioCoprocessor<'buf, N> {
    type Error = ();

    fn set_nondiscoverable(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_SET_NONDISCOVERABLE, &[])
    }

    impl_validate_variable_length_params!(
        set_limited_discoverable<'a, 'b>,
        DiscoverableParameters<'a, 'b>,
        crate::hci::opcode::GAP_SET_LIMITED_DISCOVERABLE
    );
    ...
    fn set_io_capability(&mut self, capability: IoCapability) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_SET_IO_CAPABILITY, &[capability as u8])
    }
    ...
    fn set_authorization_requirement(
        ...
        self.write_command(crate::hci::opcode::GAP_SET_AUTHORIZATION_REQUIREMENT, &bytes)
    }
    ...
    fn pass_key_response(
        ...
        self.write_command(crate::hci::opcode::GAP_PASS_KEY_RESPONSE, &bytes)
    ...
    fn authorization_response(
        ...
        self.write_command(crate::hci::opcode::GAP_AUTHORIZATION_RESPONSE, &bytes)
    }
    ...
    fn init(
        ...
        self.write_command(crate::hci::opcode::GAP_INIT, &bytes)
    }
    ...
    fn set_nonconnectable(
        ...
        match advertising_type {
            ...
            _ => {
                return Err(nb::Error::Other(Error::BadAdvertisingType(advertising_type)));
            }
        }
    ...
    fn set_undirected_connectable(
        ...
        match filter_policy {
            ...
            _ => {
                return Err(nb::Error::Other(Error::BadAdvertisingFilterPolicy(filter_policy)));
            }
        }
    ...
    impl_params!(
        ...
        crate::hci::opcode::GAP_PERIPHERAL_SECURITY_REQUEST
    );

    fn update_advertising_data(&mut self, data: &[u8]) -> nb::Result<(), Error<Self::Error>> {
        const MAX_LENGTH: usize = 31;
        if data.len() > MAX_LENGTH {
            return Err(nb::Error::Other(Error::BadAdvertisingDataLength(data.len())));
        }
        ...
        self.write_command(crate::hci::opcode::GAP_UPDATE_ADVERTISING_DATA, &bytes[0..=data.len()])
            .map_err(rewrap_error)
    }

    fn delete_ad_type(&mut self, ad_type: AdvertisingDataType) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_DELETE_AD_TYPE, &[ad_type as u8])
    }

    fn get_security_level(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_GET_SECURITY_LEVEL, &[])
    }
    ...
    fn set_event_mask(&mut self, flags: EventFlags) -> nb::Result<(), Self::Error> {
        ...
        self.write_command(crate::hci::opcode::GAP_SET_EVENT_MASK, &bytes)
    }

    fn configure_white_list(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_CONFIGURE_WHITE_LIST, &[])
    }
    ...
    fn terminate(
        ...
        match reason {
            bluetooth_hci::Status::AuthFailure
            | bluetooth_hci::Status::RemoteTerminationByUser
            | bluetooth_hci::Status::RemoteTerminationLowResources
            | bluetooth_hci::Status::RemoteTerminationPowerOff
            | bluetooth_hci::Status::UnsupportedRemoteFeature
            | bluetooth_hci::Status::PairingWithUnitKeyNotSupported
            | bluetooth_hci::Status::UnacceptableConnectionParameters => (),
        ...
        self.write_command(crate::hci::opcode::GAP_TERMINATE, &bytes)
            .map_err(rewrap_error)
    }

    fn clear_security_database(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_CLEAR_SECURITY_DATABASE, &[])
    }

    #[cfg(not(feature = "ms"))]
    fn allow_rebond(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_ALLOW_REBOND, &[])
    }
    ...
    fn allow_rebond(
        ...
        self.write_command(crate::hci::opcode::GAP_ALLOW_REBOND, &bytes)
    }

    impl_params!(
        start_limited_discovery_procedure,
        DiscoveryProcedureParameters,
        crate::hci::opcode::GAP_START_LIMITED_DISCOVERY_PROCEDURE
    );

    impl_params!(
        start_general_discovery_procedure,
        DiscoveryProcedureParameters,
        crate::hci::opcode::GAP_START_GENERAL_DISCOVERY_PROCEDURE
    );

    impl_params!(
        start_name_discovery_procedure,
        NameDiscoveryProcedureParameters,
        crate::hci::opcode::GAP_START_NAME_DISCOVERY_PROCEDURE
    );

    impl_validate_variable_length_params!(
        start_auto_connection_establishment<'a>,
        AutoConnectionEstablishmentParameters<'a>,
        crate::hci::opcode::GAP_START_AUTO_CONNECTION_ESTABLISHMENT
    );

    impl_params!(
        start_general_connection_establishment,
        GeneralConnectionEstablishmentParameters,
        crate::hci::opcode::GAP_START_GENERAL_CONNECTION_ESTABLISHMENT
    );

    impl_validate_variable_length_params!(
        start_selective_connection_establishment<'a>,
        SelectiveConnectionEstablishmentParameters<'a>,
        crate::hci::opcode::GAP_START_SELECTIVE_CONNECTION_ESTABLISHMENT
    );
    impl_params!(
        create_connection,
        ConnectionParameters,
        crate::hci::opcode::GAP_CREATE_CONNECTION
    );
    ...
    fn terminate_procedure(&mut self, procedure: Procedure) -> nb::Result<(), Error<Self::Error>> {
        ...
        self.write_command(crate::hci::opcode::GAP_TERMINATE_PROCEDURE, &[procedure.bits()])
            .map_err(rewrap_error)
    }
    ...
    impl_params!(
        ...
        crate::hci::opcode::GAP_START_CONNECTION_UPDATE
    );

    impl_params!(
        send_pairing_request,
        PairingRequest,
        crate::hci::opcode::GAP_SEND_PAIRING_REQUEST
    );
    ...
    fn resolve_private_address(
        ...
        self.write_command(crate::hci::opcode::GAP_RESOLVE_PRIVATE_ADDRESS, &addr.0)
    }

    fn get_bonded_devices(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GAP_GET_BONDED_DEVICES, &[])
    }
    ...
    fn is_device_bonded(
        ...
        self.write_command(crate::hci::opcode::GAP_IS_DEVICE_BONDED, &bytes)
    }
}
...
pub enum Error<E> {
    ...
    BadAdvertisingType(crate::hci::AdvertisingType),
    ...
    /// allowed.
    BadAdvertisingFilterPolicy(crate::hci::AdvertisingFilterPolicy),
    ...
    BadTerminationReason(bluetooth_hci::Status<crate::hci::event::Status>),
...
pub enum Pin {
    ...
    /// Pass Key Request](crate::hci::event::BlueNRGEvent::GapPassKeyRequest) event to the host.
    Requested,
...
pub struct DiscoveryProcedureParameters {
    ...
    /// Address type of this device.
    pub own_address_type: bluetooth_hci::host::OwnAddressType,
...
pub struct NameDiscoveryProcedureParameters {
    ...
    pub peer_address: bluetooth_hci::host::PeerAddrType,
...
pub struct AutoConnectionEstablishmentParameters<'a> {
    ...
    pub reconnection_address: Option<bluetooth_hci::BdAddr>,

    /// Addresses to white-list for automatic connection.
    pub white_list: &'a [bluetooth_hci::host::PeerAddrType],
}
...
pub struct SelectiveConnectionEstablishmentParameters<'a> {
    /// Type of scanning
    pub scan_type: bluetooth_hci::host::ScanType,
...
pub struct BroadcastModeParameters<'a, 'b> {
    ...
    ///
    /// Only the [ScannableUndirected](bluetooth_hci::types::AdvertisingType::ScannableUndirected) and
    /// [NonConnectableUndirected](bluetooth_hci::types::AdvertisingType::NonConnectableUndirected).
    pub advertising_interval: bluetooth_hci::types::AdvertisingInterval,
    ...
    pub white_list: &'b [bluetooth_hci::host::PeerAddrType],
}
...
impl<'a, 'b> BroadcastModeParameters<'a, 'b> {
    ...
    fn validate<E>(&self) -> Result<(), Error<E>> {
        ...
        match self.advertising_interval.advertising_type() {
            bluetooth_hci::types::AdvertisingType::ScannableUndirected
            | bluetooth_hci::types::AdvertisingType::NonConnectableUndirected => (),
...
pub struct ObservationProcedureParameters {
    /// Scanning window.
    pub scan_window: bluetooth_hci::types::ScanWindow,
    ...
    /// report](bluetooth_hci::event::Event::LeAdvertisingReport).
    pub filter_duplicates: bool,
}
