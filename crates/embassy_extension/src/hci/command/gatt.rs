...
use crate::hci::event::AttributeHandle;
...
pub trait GattCommands {
    ...
    /// # Generated events
    ///
    /// A [command status](bluetooth_hci::event::Event::CommandStatus) event is generated on the receipt of
...
impl<'buf, const N: usize> GattCommands for crate::hci::RadioCoprocessor<'buf, N> {
    type Error = ();

    fn init(&mut self) -> nb::Result<(), Self::Error> {
        self.write_command(crate::hci::opcode::GATT_INIT, &[])
    }
    ...
    fn delete_characteristic(
        ...
        self.write_command(crate::hci::opcode::GATT_DELETE_CHARACTERISTIC, &bytes)
    }
    ...
    fn delete_service(&mut self, service: ServiceHandle) -> nb::Result<(), Self::Error> {
        ...
        self.write_command(crate::hci::opcode::GATT_DELETE_SERVICE, &bytes)
    }
    ...
    impl_value_params!(set_event_mask, Event, crate::hci::opcode::GATT_SET_EVENT_MASK);
    ...
    fn exchange_configuration(
        ...
        self.write_command(crate::hci::opcode::GATT_EXCHANGE_CONFIGURATION, &bytes)
    }
    ...
    fn find_information_request(
        ...
        self.write_command(crate::hci::opcode::GATT_FIND_INFORMATION_REQUEST, &bytes)
    }

    impl_validate_variable_length_params!(
        find_by_type_value_request<'a>,
        FindByTypeValueParameters<'a>,
        crate::hci::opcode::GATT_FIND_BY_TYPE_VALUE_REQUEST
    );

    impl_variable_length_params!(
        read_by_type_request,
        ReadByTypeParameters,
        crate::hci::opcode::GATT_READ_BY_TYPE_REQUEST
    );

    impl_variable_length_params!(
        read_by_group_type_request,
        ReadByTypeParameters,
        crate::hci::opcode::GATT_READ_BY_GROUP_TYPE_REQUEST
    );

    impl_validate_variable_length_params!(
        prepare_write_request<'a>,
        WriteRequest<'a>,
        crate::hci::opcode::GATT_PREPARE_WRITE_REQUEST
    );
    ...
    fn execute_write_request(
        ...
        self.write_command(crate::hci::opcode::GATT_EXECUTE_WRITE_REQUEST, &bytes)
    }
    ...
    fn discover_all_primary_services(
        ...
        self.write_command(crate::hci::opcode::GATT_DISCOVER_ALL_PRIMARY_SERVICES, &bytes)
    }
    ...
    fn discover_primary_services_by_uuid(
        ...
        self.write_command(
            crate::hci::opcode::GATT_DISCOVER_PRIMARY_SERVICES_BY_UUID,
            &bytes[..end],
        )
    }
    ...
    fn find_included_services(
        ...
        self.write_command(crate::hci::opcode::GATT_FIND_INCLUDED_SERVICES, &bytes)
    }
    ...
    fn discover_all_characteristics_of_service(
        ...
        self.write_command(crate::hci::opcode::GATT_DISCOVER_ALL_CHARACTERISTICS_OF_SERVICE, &bytes)
    }
    ...
    fn discover_characteristics_by_uuid(
        ...
        self.write_command(
            crate::hci::opcode::GATT_DISCOVER_CHARACTERISTICS_BY_UUID,
            &bytes[..6 + uuid_len],
        )
    }
    ...
    fn discover_all_characteristic_descriptors(
        ...
        self.write_command(crate::hci::opcode::GATT_DISCOVER_ALL_CHARACTERISTIC_DESCRIPTORS, &bytes)
    }
    ...
    fn read_characteristic_value(
        ...
        self.write_command(crate::hci::opcode::GATT_READ_CHARACTERISTIC_VALUE, &bytes)
    }
    ...
    fn read_characteristic_using_uuid(
        ...
        self.write_command(
            crate::hci::opcode::GATT_READ_CHARACTERISTIC_BY_UUID,
            &bytes[..6 + uuid_len],
        )
    }
    ...
    impl_params!(
        ...
        crate::hci::opcode::GATT_READ_LONG_CHARACTERISTIC_VALUE
    );

    impl_validate_variable_length_params!(
        read_multiple_characteristic_values<'a>,
        MultipleCharacteristicReadParameters<'a>,
        crate::hci::opcode::GATT_READ_MULTIPLE_CHARACTERISTIC_VALUES
    );

    impl_validate_variable_length_params!(
        write_characteristic_value<'a>,
        CharacteristicValue<'a>,
        crate::hci::opcode::GATT_WRITE_CHARACTERISTIC_VALUE
    );

    impl_validate_variable_length_params!(
        write_long_characteristic_value<'a>,
        LongCharacteristicValue<'a>,
        crate::hci::opcode::GATT_WRITE_LONG_CHARACTERISTIC_VALUE
    );

    impl_validate_variable_length_params!(
        write_characteristic_value_reliably<'a>,
        LongCharacteristicValue<'a>,
        crate::hci::opcode::GATT_WRITE_CHARACTERISTIC_VALUE_RELIABLY
    );

    impl_validate_variable_length_params!(
        write_long_characteristic_descriptor<'a>,
        LongCharacteristicValue<'a>,
        crate::hci::opcode::GATT_WRITE_LONG_CHARACTERISTIC_DESCRIPTOR
    );

    impl_params!(
        read_long_characteristic_descriptor,
        LongCharacteristicReadParameters,
        crate::hci::opcode::GATT_READ_LONG_CHARACTERISTIC_DESCRIPTOR
    );

    impl_validate_variable_length_params!(
        write_characteristic_descriptor<'a>,
        CharacteristicValue<'a>,
        crate::hci::opcode::GATT_WRITE_CHARACTERISTIC_DESCRIPTOR
    );
    ...
    fn read_characteristic_descriptor(
        ...
        self.write_command(crate::hci::opcode::GATT_READ_CHARACTERISTIC_DESCRIPTOR, &bytes)
    }
    ...
    fn confirm_indication(
        ...
        self.write_command(crate::hci::opcode::GATT_CONFIRM_INDICATION, &bytes)
    }
    ...
    fn allow_read(
        ...
        self.write_command(crate::hci::opcode::GATT_ALLOW_READ, &bytes)
    }
    ...
    fn read_handle_value(&mut self, handle: CharacteristicHandle) -> nb::Result<(), Self::Error> {
        ...
        self.write_command(crate::hci::opcode::GATT_READ_HANDLE_VALUE, &bytes)
    }
    ...
    fn read_handle_value_offset(
        ...
        self.write_command(crate::hci::opcode::GATT_READ_HANDLE_VALUE_OFFSET, &bytes)
    }
...
pub struct WriteResponseParameters<'a> {
    ...
    pub status: Result<(), bluetooth_hci::Status<crate::hci::event::Status>>,
